...
#ifndef STACK_DUMP_STRATEGY_H
#define STACK_DUMP_STRATEGY_H
...
namespace OHOS {
namespace HiviewDFX {
class StackDumpStrategy : public DumpStrategy {
public:
    StackDumpStrategy() = default;
