...
DumpStatus KernelModuleInfoWriter::TaskEntry(DataInventory& dataInventory, const DumpContext& dumpContext)
{
...
REGISTER_TASK(TaskId::WRITE_KERNEL_MODULE_INFO, KernelModuleInfoWriter, true, TaskId::DUMP_KERNEL_MODULE_INFO);
REGISTER_DEPENDENT_DATA(TaskId::WRITE_KERNEL_MODULE_INFO,
                        DataId::PRINTENV_INFO, DataId::PROC_MODULES_INFO, DataId::LSMOD_INFO);
} // namespace HiviewDFX
} // namespace OHOS
