...
DumpStatus SystemClusterInfoTask::TaskEntry(DataInventory& dataInventory, const DumpContext& dumpContext)
{
...
REGISTER_TASK(TaskId::DUMP_SYSTEM_CLUSTER_INFO, SystemClusterInfoTask, true);
} // namespace HiviewDFX
} // namespace OHOS