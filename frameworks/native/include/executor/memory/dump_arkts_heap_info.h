 ...
 */
#ifndef DUMP_ARKTS_HEAP_INFO_H
#define DUMP_ARKTS_HEAP_INFO_H
...
namespace HiviewDFX {
#ifdef HIDUMPER_ABILITY_RUNTIME_ENABLE
class ArktsHeapDumpCallback : public IRemoteStub<AppExecFwk::IMemDumpCallback> {
public:
    ArktsHeapDumpCallback() : completed_(false) {}
    ~ArktsHeapDumpCallback() = default;
    ...
    bool WaitForResult(std::string &dumpResult, int32_t timeoutMs)
    {
