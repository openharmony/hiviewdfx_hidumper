...
void DumperOpts::ResetJsHeapOptions()
{
    ...
    isDumpHeapArkwebJs_ = false;
    dumpHeapRenderPid_ = 0;
    isDumpHeapMemGc_ = false;
    dumpRawHeap_ = false;
...
void DumperOpts::AssignMemOptions(const DumperOpts& opts)
{
    ...
    showArktsHeap_ = opts.showArktsHeap_;
...
void DumperOpts::AssignJsHeapOptions(const DumperOpts& opts)
{
    ...
    isDumpHeapArkwebJs_ = opts.isDumpHeapArkwebJs_;
    dumpHeapRenderPid_ = opts.dumpHeapRenderPid_;
    isDumpHeapMemGc_ = opts.isDumpHeapMemGc_;
